...
b.	Without prejudice to GovTech’s other rights, you shall not (and shall not allow or permit any third party to): (a) reverse engineer, disassemble, decompile, or translate the Service or otherwise attempt to derive the source code version of the Service; (b) load, execute, access, utilise, perform, display or copy (collectively in this sub-clause, “**Use**”) the Service or any portion thereof to create or develop any developer tools (including plug-ins and middleware) or any software; (c) rent, lease, loan or otherwise in any manner provide, transfer or distribute the Service or any part thereof to any third party; (d) Use the Service in violation of applicable laws, or infringe, violate or otherwise misappropriate the intellectual property or rights of any third party (including any moral right, privacy right or right of publicity); (e) circumvent any user limits or other license timing or use restrictions that are built into the Service; (f) reproduce, distribute, publicly perform, publicly display or create adaptations or derivative works of or based on the Service; (g) remove any copyright, trademark, or other applicable proprietary notices contained on the Service, (h) possess, download or copy the Service or any part of the Service (for the avoidance of doubt, this does not include data provided by public sector agencies for exchange), including but not limited to any component which comprises the Service, but not including any output from the Service; (i) knowingly interfere with Service, intentionally submitting a virus, overloading, flooding, spamming, mail bombing or crashing; (j) circumvent any timing restrictions that are built into the Service or any portion thereof; (k) Use the Service to create, collect, transmit, store, use or process any data that: (i) you do not have the lawful right to create, collect, transmit, store, use or process or (ii) or (ii) violates any applicable laws, or infringes, violates or otherwise misappropriates the intellectual property or other rights of any third party (including any moral right, privacy right or right of publicity).
