...
(3)	**Late payment**: Where you fail to make any payment when such payments fall due, without prejudice to any other rights or remedy available to GovTech, GovTech shall be entitled to (whether by GovTech itself or through Assurity): 
	(i)	immediately suspend, interrupt or terminate your account, the Service or any part thereof; and/or
...
<table>
  <tr>
    <th>S/N</th>
    <th>OSS Licence</th>  
    <th>Component to which Licence applies</th>
    <th>Link</th>
  </tr>
  <tr>
    <td>1</td>
...
a.	These Terms of Use contains the entire and whole agreement concerning the subject matter of these Terms of Use. The Terms of Use supersedes all prior written or oral representations, agreements and/or understandings between GovTech and yourself. Except for amendments by GovTech under these Terms of Use, no amendment to these Terms of Use shall be of any force unless agreed upon in writing by both parties.

b.	Without prejudice to GovTech’s other rights, you shall not (and shall not allow or permit any third party to): (1) reverse engineer, disassemble, decompile, or translate the Service or otherwise attempt to derive the source code version of the Service; (2) load, execute, access, utilise, perform, display or copy (collectively in this sub-clause, “**Use**”) the Service or any portion thereof to create or develop any developer tools (including plug-ins and middleware) or any software; (83) rent, lease, loan or otherwise in any manner provide, transfer or distribute the Service or any part thereof to any third party; (4) Use the Service in violation of applicable laws, or infringe, violate or otherwise misappropriate the intellectual property or rights of any third party (including any moral right, privacy right or right of publicity); (5) circumvent any user limits or other license timing or use restrictions that are built into the Service; (6) reproduce, distribute, publicly perform, publicly display or create adaptations or derivative works of or based on the Service; (7) remove any copyright, trademark, or other applicable proprietary notices contained on the Service, (8) possess, download or copy the Service or any part of the Service (for the avoidance of doubt, this does not include data provided by public sector agencies for exchange), including but not limited to any component which comprises the Service, but not including any output from the Service; (9) knowingly interfere with Service, intentionally submitting a virus, overloading, flooding, spamming, mail bombing or crashing; (10) circumvent any timing restrictions that are built into the Service or any portion thereof; (11) Use the Service to create, collect, transmit, store, use or process any data that: (i) you do not have the lawful right to create, collect, transmit, store, use or process or (ii) violates any applicable laws, or infringes, violates or otherwise misappropriates the intellectual property or other rights of any third party (including any moral right, privacy right or right of publicity).
...
d.	 Any delay, failure or omission on the part of GovTech in enforcing any right, power, privilege, claim or remedy (“**Remedy**”), which is conferred under the Terms of Use or at law or in equity, or arises from any breach by you, shall not (1) be deemed to be or be construed as a waiver or variation of the Remedy, or of any other such Remedy, in respect of the particular circumstances in question, or (2) operate so as to bar the enforcement or exercise of the Remedy, or of any other such Remedy in any other subsequent instances. No waiver of any breach of the Terms of Use shall be deemed to be a waiver of any other or of any subsequent breach. Any waiver granted under the Terms of Use must be in writing and may be given subject to conditions. Such waiver under the Terms of Use shall be effective only in the instance and for the purpose for which it is given.
